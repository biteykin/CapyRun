# app.py — CapyRun FIT Analyzer v3.2
# - Single workout report: metrics, charts, zones, tables, Excel
# - Multi workouts dashboard: summaries, ATL/CTL/TSB, 7-day draft plan, ICS export, Excel
# - No GPS stored/shown; safe dtype handling for dates; robust scope for plan_df
...
import datetime as dt  # for ICS export

# ---------------- UI / Sidebar ----------------
st.set_page_config(page_title="CapyRun — FIT Analyzer v3.2", page_icon="🏃", layout="wide")
st.title("🏃 CapyRun — FIT Analyzer v3.2")
st.caption("Загрузи один или несколько .fit → отчёт по сессии / тренды нагрузки / черновик плана + календарь (ICS) + Excel")
